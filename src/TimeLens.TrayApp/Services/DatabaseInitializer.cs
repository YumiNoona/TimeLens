    ...
    public static AppSettings Initialize(string dbPath)
    {
        ...
        cmd.CommandText = """
            ...
            INSERT OR IGNORE INTO settings (key, value) VALUES ('time_format', '12h');
              ...
              INSERT OR IGNORE INTO settings (key, value) VALUES ('default_view', 'today');
              ...
              INSERT OR IGNORE INTO settings (key, value) VALUES ('heatmap_days', '365');
              UPDATE settings SET value = '365' WHERE key = 'heatmap_days' AND value IN ('28','273');
